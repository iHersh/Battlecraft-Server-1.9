	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if (cmd.getName().equalsIgnoreCase("tell")) {
			...
			if (args.length > 2) {
				...
				String msg1 = ChatColor.GOLD + "" + ChatColor.BOLD + "[" + ChatColor.YELLOW + "" + ChatColor.BOLD + sender.getName() +
						" " + ChatColor.GOLD + "" + ChatColor.BOLD + "> " + ChatColor.YELLOW + "" + ChatColor.BOLD + tar.getName()
						+ ChatColor.GOLD + "" + ChatColor.BOLD + "] ";
				String msg2 = ChatColor.GOLD + "" + ChatColor.BOLD + "[" + ChatColor.YELLOW + "" + ChatColor.BOLD + tar.getName() +
						" " + ChatColor.GOLD + "" + ChatColor.BOLD + "< " + ChatColor.YELLOW + "" + ChatColor.BOLD + sender.getName()
						+ ChatColor.GOLD + "" + ChatColor.BOLD + "] ";
