...
public class SimpleHelp {
	 ...
	 * 
	 * public SimpleHelp(BattlecraftServer p) { this.plugin = p; }
	 * 
	 * @Override public boolean onCommand(CommandSender sender, Command cmd,
	 * String label, String[] args) { for (String list :
	 * plugin.getConfig().getStringList("helpblockmessages")) { if
	 * (!sender.hasPermission("bc.helpbypass")) {
